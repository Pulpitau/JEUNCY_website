...
// Les memes onglets pour tout le monde. L'onglet « Tarifs » reserve aux
// entreprises connectees (2026-08-17) a disparu avec les tarifs eux-memes.
...
export function Navbar() {
  ...
  // doivent afficher exactement les memes onglets.
  const navLinks = navLinksFor();
